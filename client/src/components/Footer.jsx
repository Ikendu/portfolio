...
export default function Footer() {
  ...
  const socials = [
    ...
    { url: 'https://linkedin.com/in/aniede', icon: linkedin, label: 'LinkedIn' },
    { url: 'https://www.facebook.com/chibundu101/', icon: facebook, label: 'Facebook' },
    { url: 'https://twitter.com/ikendul', icon: twitter, label: 'Twitter' },
    { url: 'http://github.com/ikendu', icon: github, label: 'GitHub' },
    { url: 'https://www.instagram.com/chibundu.aniede', icon: instagram, label: 'Instagram' },
  ]
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-8'>
          ...
          <div className='flex flex-col items-center md:items-start gap-4'>
            <img src={logo} alt='Logo' className='w-16 h-16 rounded-full border-2 border-cyan-400' />
            <div>
              <h3 className='text-white font-bold text-lg'>David Aniede</h3>
        ...
        <div className='border-t border-slate-800 py-8 mb-8'>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-6 text-center md:text-left'>
            ...
            <a href='#' className='text-gray-400 hover:text-cyan-400 transition'>Privacy</a>
          </div>
        </div>
