            ...
            <TrackVisibility>
              {({ isVisible }) => (
                <div
                  className={
                    isVisible
                      ? 'skill-bx p-3 py-5 flex flex-column align-items-center gap-3 md:gap-20 animate__animated animate__backInLeft'
                      : `skill-bx p-3 py-5 flex flex-column align-items-center gap-3 md:gap-20`
                  }
                >
                  <h2>Skills</h2>
                  <div className=''>
